// import { render as renderMainPage } from "./main-page.js";
// import { render as renderDetailPage } from "./details.js";
import { changeRender } from "../main.js";
...
export function createItemSection(name) {
    ...
    new Promise((resolve) => {
        itemImg.addEventListener('load', () => resolve())
    })
